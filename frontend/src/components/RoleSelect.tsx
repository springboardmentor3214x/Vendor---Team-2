...
import { Shield, ChevronLeft, Eye, EyeOff, Building2, ShoppingCart, Activity, IndianRupee, FileBarChart } from "lucide-react";
...
export function RoleSelect({ onLoginSuccess }: RoleSelectProps) {
  ...
  const roles: { role: Role; desc: string; icon: React.ElementType; color: string; bg: string }[] = [
    ...
    { role: "Finance Officer",      desc: "Budgets & payments",          icon: IndianRupee,  color: "#E65100", bg: "#FFF3E0" },
