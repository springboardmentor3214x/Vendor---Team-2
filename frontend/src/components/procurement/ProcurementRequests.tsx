  ...
  return (
    <div style={{ padding: "24px 28px", fontFamily: "Inter, sans-serif" }}>
      ...
      {viewState === "list" ? (
                          ...
                          <tr key={r.id} style={{ borderBottom: "1px solid #F1F5F9" }}>
                            ...
                            <td style={{ padding: "12px 14px" }}>
                              <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                                ...
                                {canAction && r.status === "Approved" && !r.assignedVendorId && !r.assignedVendorName && (
        ...
        <div style={{ maxWidth: 800, margin: "0 auto", padding: 32, background: "#fff", borderRadius: 12, border: "1px solid #E4E7EC", textAlign: "center" }}>
          <h2 style={{ fontSize: 18, fontWeight: 800, color: "#B71C1C", margin: 0 }}>Access Restricted</h2>
          <p style={{ fontSize: 13, color: "#667085", marginTop: 8 }}>
            Users with the <b>Auditor</b> role are restricted from creating or editing procurement requests to enforce segregation of duties.
          </p>
          <button onClick={() => setViewState("list")} style={{ marginTop: 16, background: roleColor, color: "#fff", border: "none", borderRadius: 8, padding: "8px 18px", fontSize: 13, fontWeight: 600, cursor: "pointer" }}>
