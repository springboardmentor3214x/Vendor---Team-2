...
import { Award, ShieldAlert, Sparkles, TrendingUp, Download, AlertTriangle, Star, CheckCircle, XCircle, Clock, IndianRupee, Globe, Zap } from "lucide-react";
      ...
      {viewMode === "analytics" && (
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14 }}>
            {[
              { label: "YTD SPEND",         value: "₹8.29 Cr", delta: "+12.4%",    det: "vs last month",  color: "#1565C0", icon: IndianRupee,  good: true  },
